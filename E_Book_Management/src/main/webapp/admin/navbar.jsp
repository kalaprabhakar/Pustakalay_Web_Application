...
<div class="container-fluid p-3 bg-light">
	<div class="row">
		<div class="col-md-3 text-success">
			<h3>
				<i class="fa-solid fa-book"></i>Pustakalaya
			</h3>
		</div>
		...
		<div class="col-md-6 ">
			<c:if test="${ not empty userobj}">
				<a  class="btn btn-success text-white"><i
					...
					<a  data-toggle="modal" data-target="#exampleModalCenter"class="btn btn-success"><i
    ...
    <div class="modal-content">
      ...
      <div class="text-center">
       <h4>Do You Want Logout</h4>
        ...
        <a href="../logout" type="button" class="btn btn-primary text-whilte">Logout</a>
      </div>
      </div>
